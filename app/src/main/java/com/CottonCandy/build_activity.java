...
public class build_activity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adr = new ArrayAdapter<String>(build_activity.this, android.R.layout.simple_list_item_1, data);	
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		switch (item.getItemId())
		{
			case R.id.share:
                ...
                textIntent.putExtra(Intent.EXTRA_TEXT, shar.substring(4,shar.length()));
                startActivity(Intent.createChooser(textIntent, "分享设备信息"));
				break;

			case R.id.copyall:
				ClipboardManager cm = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
				cm.setText(shar.substring(4,shar.length()));
